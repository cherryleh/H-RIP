<head>
    <title><?php echo $_GET["ranch"];?> Ranch Page</title>
        ...
        <main class="main">
                            ...
                            <div>
                                <form class="switchButton">
                                    <div class="switch-field">
                                        <input type="radio" id="radio-one" name="switch-one" value="daily_r" checked />
                            ...
                            <i class="bi bi-question-circle tool" style="float:right">
                                <div class="tooltip">
                                    <div class="tooltip-content">
                                        ...
                                        <p><span class="bold">Consecutive dry days:</span> Number of days where rainfall
                                            has
                            ...
                            <i class="bi bi-question-circle tool" style="float:right">
                                <div class="tooltip">
                                    <div class="tooltip-content">
                                        ...
                                        <p><span class="bold">Total dry days: </span> Total days in month where rainfall
                                ...
                                <div>
                                    <form class="switchButton">
                                        <div class="switch-field">
                                            ...
                                            <input type="radio" id="radio-four" name="switch-two" value="monthly_t" />
                                ...
                                <i class="bi bi-question-circle tool" style="float:right">
                                    <div class="tooltipRight">
                                        <div class="tooltip-content">
                                            ...
                                            <p>Yesterday's average, minimum, and maximum temperature. Difference is in
                                ...
                                <i class="bi bi-question-circle tool" style="float:right">
                                    <div class="tooltipRight">
                                        <div class="tooltip-content">
                                            ...
                                            <p>Last month's average, minimum, and maximum temperature. Difference is in
                ...
                <div class="dashboardCard" style="display: table; height:95%">
                    <div class="table rel">
                        ...
                        <i class="bi bi-question-circle tool pos">
                            <div class="tooltip">
                                <div class="tooltip-content">
                                    <p>Drought history uses the 3-month Standard Precipitation Index (SPI) to determine
                                        drought.
                                    </p>
                        ...
                        <i class="bi bi-question-circle tool pos" style="z-index:0">
                            <div class="tooltipRight">
                                <div class="tooltip-content">
                                    ...
                                    <p><span class="bold">During a La Niña: </span>Typically dry summers and wet winters
                                    </p>
                                </div>
                            </div>
                        </i>
            ...
            <div id="rainOutlook-content">
                ...
                <div id="rainProj">
                    ...
                    <a href="./RID/<?php echo $_GET["ranch"] ?>/<?php echo $_GET["ranch"] ?>_rainfall.png" style="color:inherit"
                        target="_blank">
            ...
            <div class="main_cards card-margin">
                ...
                <div class="card">
                    <a class="map-img" href="./RID/<?php echo $_GET["ranch"] ?>/<?php echo $_GET["ranch"] ?>_rf.png"
                        style="color:inherit" target="_blank">
                        <img style="" src="./RID/<?php echo $_GET["ranch"] ?>/<?php echo $_GET["ranch"] ?>_rf.png"></a>
                </div>
            ...
            <div class="main_cards card-margin">
                ...
                <div class="card">
                    <a class="map-img" href="./RID/<?php echo $_GET["ranch"] ?>/<?php echo $_GET["ranch"] ?>_temp.png"
                        style="color:inherit" target="_blank">
                        <img style=""
            ...
            <div class="et_cards card-margin">
                ...
                <div class="card1 center">
                    ...
                    <div class="diff_temp">
                        <p><span <?php echo $style_et . '>' . $dif_et . '%</span> ' . $status_et ?> monthly average</p>
                    </div>
                    <div style="text-align: center; margin-top: 2%;">
                ...
                <div class="card1">
                    <a class="map-img" href="./RID/<?php echo $_GET["ranch"] ?>/<?php echo $_GET["ranch"] ?>_et.png"
                        style="color:inherit" target="_blank">
                        <img style="" src="./RID/<?php echo $_GET["ranch"] ?>/<?php echo $_GET["ranch"] ?>_et.png"></a>
                ...
                <div class="card1">
                    <p> Evapotranspiration is the combination of processes that takes water from the surface
                        ...
                        plant's leaves, a process called transpiration. To learn more, click <a
                            ...
                            style="font-style: italic;">Source: <a href="https://earthengine.google.com/">Google Earth
                                Engine</a></span>
                    </p>
                </div>
            </div>
            ...
            <div class="et_cards card-margin">
                ...
                <div class="card1 center">
                    ...
                    <div class="diff_temp">
                        <p>
                            <?php echo '<span ' . $style_ndvi . '>' . $dif_ndvi . '</span> ' . $status_ndvi ?> monthly
                            average
                        </p>
                    </div>
                    <div style="text-align: center; margin-top: 2%;">
                ...
                <div class="card1">
                    <a class="map-img" href="./RID/<?php echo $_GET["ranch"] ?>/<?php echo $_GET["ranch"] ?>_ndvi.png"
                        style="color:inherit" target="_blank">
                        <img style=""
                            src="./RID/<?php echo $_GET["ranch"] ?>/<?php echo $_GET["ranch"] ?>_ndvi.png"></a>
                </div>
                <div class="card1">
                    <p>Normalized Difference Vegetation Index (NDVI) is a widely used vegetation index that measures the
                        density of green in a region and is often used to monitor drought, forecast agricultural
                        production, and more. Values range from +1.0 to -1.0. High NDVI values (approximately 0.6 to
